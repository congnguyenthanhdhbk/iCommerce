...
public class GenericFilterCriteriaBuilder {
    ...
    public Query addCondition(final List<FilterCondition> andConditions,
                              final List<FilterCondition> orConditions) {
     ...
     */
    private Criteria buildCriteria(final FilterCondition condition) {
        Function<FilterCondition, Criteria> function = FILTER_CRITERIA.get(condition.getOperator().name());
